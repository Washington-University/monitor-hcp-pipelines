"""CheckHcpPipelineStatusPrisma3T.py
...
def check_functional_status(verbose, getHCP, subject_to_check, task_names):
    ...
    for i in xrange(0, len(functional_task_names)):
        functional_task_list.append(functional_task_names[i]+"_PA_preproc")
        unproc_task_list.append(functional_task_names[i]+"_PA_unproc")
        functional_task_list.append(functional_task_names[i]+"_AP_preproc")
        unproc_task_list.append(functional_task_names[i]+"_AP_unproc")
...
#        fix_task_list.append(fix_task_names[i]+"_PA_FIX")
#        preproc_task_list.append(fix_task_names[i]+"_PA_preproc")
#        fix_task_list.append(fix_task_names[i]+"_AP_FIX")
#        preproc_task_list.append(fix_task_names[i]+"_AP_preproc")

    fix_task_list = list()
    for i in xrange(0, len(fix_task_names)):
        fix_task_list.append(fix_task_names[i]+"_PA")
        fix_task_list.append(fix_task_names[i]+"_AP")
